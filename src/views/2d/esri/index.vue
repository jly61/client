  ...
  export default {
    ...
    mounted() {
      this.$nextTick(() => {
        ...
        // 初始化地图
        this.initMap()
        this.drawCanvas(this.month, this.day, this.hour)
      })
    },
    methods: {
      showChild(date) {
      ...
      initMap() {
        esriLoader.loadModules([
          ...
          .then(([Map, MapView, BaseDynamicLayer, Basemap, TileLayer]) => {
            let layer = new TileLayer({
              url: "http://map.geoq.cn/ArcGIS/rest/services/ChinaOnlineCommunity/MapServer"
            });
            let imgBasemap  = new Basemap({
              baseLayers: [layer]
            });
            ...
            this.view = new MapView({
              container: "map",
              map: this.map,
              center: [100.36795152905626, 30.1278045049863],
              zoom: 7
            });
          })
      },
          ...
          .then(([Map, MapView, BaseDynamicLayer, Basemap, TileLayer]) => {
            ...
            axios.get('http://localhost:3000/weathers/kri-hour', { params: param }).then(res => {
              ...
              function loadkriging() {
                ...
                const width = 0.01
                const grid = kriging.grid(_this.world, variogram, width)
              ...
              var CustomImageOverlayLayer = BaseDynamicLayer.createSubclass({
                ...
                getImageUrl: function(extent, width, height) {
                  ...
                  var screenPoint = _this.view.toScreen(mapPoint);
                  ...
                  var screen_leftbottom  = _this.view.toScreen(leftbottom);
                  //右上角
                  var righttop = {
                    x: this.extent.xmax,
                    y: this.extent.ymax,
              ...
              this.view.when(function(){
                var ImageOverlayLayer = new CustomImageOverlayLayer({
                  picUrl: returnImage(),
                  extent:{xmin: 97.3481, ymin: 26.0459, xmax: 108.5467, ymax: 34.3129}
                });
                ...
                setTimeout(function () {
                  ...
                  _this.view.center = center;
                  _this.view.goTo(_this.view.center,
                    {
                      speedFactor: 0.1,
