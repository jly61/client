        ...
        <div class="time">
            <div class="hour">
                <a href="#" v-for="(item, index) in hourList" v-if="item < 10"
                   @click="drawCanvas(6,26,item)" :class="{'hour-selected': hourFlag===item}"> 0{{item}}:00 </a>
                <a href="#" v-else="item >= 10" @click="drawCanvas(6,26,item)"
    ...
    export default {
        ...
        mounted() {
            this.$nextTick(() => {
                ...
                // 初始化地图
                this.initMap()
                this.drawCanvas(6, 27, this.hour)
            })
        },
        methods: {
            showChild(date) {
                ...
                this.day = date.day
                console.log(date)
                this.drawCanvas(6, 28, this.hour)
            },
            initMap() {
                this.map = L.map('map', {
                ...
                let positions = []
                this.world[0].forEach(function(point) {
                    positions.push([point[1], point[0]])
                })
                let scope = L.polyline(positions, { color: 'red' }).addTo(this.map)
            ...
            drawCanvas(month, day, hour) {
                ...
                axios.get('http://localhost:3000/weathers/kri-hour', { params: param }).then(res => {
                    ...
                    function loadkriging() {
                        ...
                        let width = 0.05
                        let grid = kriging.grid(_this.world, variogram, width)
                    ...
                    loadkriging()
                    let imageBounds = [[26.0459, 97.3481], [34.3129, 108.5467]]
                    L.imageOverlay(returnImgae(), imageBounds, { opacity: 0.8 }).addTo(this.map)
                })
            }
        }
    }
