<template>
  <div id="map">
    <date-picker class="date-picker" @listenChild="showChild" />
    <div class="time">
      <div class="hour">
        <a
          ...
          v-if="item < 10"
          href="#"
          :class="{'hour-selected': hour===item}"
          @click="initMap(month,day,item)"
        > 0{{ item }}:00 </a>
        <a
          v-else="item >= 10"
          href="#"
  ...
  methods: {
    ...
    initMap(month, day, hour) {
      ...
      axios.get('http://localhost:3000/weathers/kri-hour', { params: param }).then((weaRes) => {
        const weaArr = weaRes.data.result
        console.log(weaArr)
        weaArr.forEach((item) => {
        ...
        const drawKriging = function(extent) {
          const values = []; const lngs = []; const lats = []
