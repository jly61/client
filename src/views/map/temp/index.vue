  ...
  export default {
    ...
    methods: {
      ...
      drawCanvas(month, day) {
        ...
        axios.get('http://localhost:3000/weathers/kri-day', { params: param }).then(res => {
          ...
          function loadkriging() {
            ...
            const y = []
            for (let i = 0; i < n; i++) {
              t.push(parseFloat(_this.points[i].avgTemp))
              x.push(parseFloat(_this.points[i].other[0].lon)) // lon
              y.push(parseFloat(_this.points[i].other[0].lat)) // lat
              // axios.get(`/caiyun/${_this.points[i].other[0].lon},${_this.points[i].other[0].lat}/forecast.json?unit=metric:v2`).then(res => {
              //   t.push(res.data.result.hourly.temperature[0].value)
              // })
            }
